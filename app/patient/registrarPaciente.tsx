...
// Importamos el servicio que ya habías creado
...
export default function RegistrarPacienteScreen() {
  ...
  // Estado basado en tu esquema Infante
  ...
  async function handleGuardar() {
    // Aquí iría la lógica para guardar en la tabla 'paciente_inf'
  ...
  return (
    ...
    >
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <Text style={styles.subtitle}>Registra la información del infante para iniciar el seguimiento.</Text>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.row}>
            <View style={{ flex: 1, marginRight: 10 }}>
              ...
              <TextInput
                ...
                onChangeText={(v) => update('edad', parseInt(v) || 0)}
              />
            </View>
            <View style={{ flex: 1 }}>
              ...
              <TextInput
                style={styles.input}
                placeholder="M / F"
                onChangeText={(v) => update('genero', v)}
              />
            </View>
          </View>
          ...
          <View style={styles.row}>
            <View style={{ flex: 1, marginRight: 10 }}>
              ...
              <TextInput
                ...
                onChangeText={(v) => update('peso', parseFloat(v) || 0)}
              />
            </View>
            <View style={{ flex: 1 }}>
              ...
              <TextInput
                ...
                placeholder="0"
                keyboardType="numeric"
                onChangeText={(v) => update('estatura', parseInt(v) || 0)}
              />
            </View>
          </View>
          ...
          <TextInput
            ...
            onChangeText={(v) => update('nomtuto', v)}
          />

          <Text style={styles.label}>Problemas de salud o alergias</Text>
          <TextInput
            style={[styles.input, { height: 80 }]}
            placeholder="Describe brevemente si hay condiciones previas"
            multiline
            onChangeText={(v) => update('problemas_salud', v)}
          />
        </View>
